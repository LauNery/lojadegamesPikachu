package com.generation.lojadegamespikachu.controller;
...
import com.generation.lojadegamespikachu.repository.ProdutoRepository;
...
public class ProdutoController {
	...
	return ResponseEntity.ok(produtoRepository.findAllByPreco(null));
	}
	@GetMapping("/frete/{frete}")
	public ResponseEntity<List<Produto>> getByFrete(@PathVariable BigDecimal frete) {
	return ResponseEntity.ok(produtoRepository.findAllByFrete(null));
	}
	@GetMapping("/fornecedor/{fornecedor}")
	public ResponseEntity<List<Produto>> getByFornecedor(@PathVariable String fornecedor) {
	return ResponseEntity.ok(produtoRepository.findAllByFornecedorContainingIgnoreCase(fornecedor));
	}
